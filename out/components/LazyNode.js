...
exports.LazyNode = (0, react_1.memo)(({ data, selected }) => {
    ...
    return (react_1.default.createElement("div", { ref: nodeRef, style: {
        ...
        react_1.default.createElement(reactflow_1.Handle, { type: "target", position: reactflow_1.Position.Top, style: { background: '#4a9eff', width: 8, height: 8 } }),
        react_1.default.createElement("div", { style: { display: 'flex', alignItems: 'center', gap: '8px' } },
            ...
            react_1.default.createElement("div", { style: { flex: 1, overflow: 'hidden' } },
                ...
                data.type && (react_1.default.createElement("div", { style: { color: '#888', fontSize: '10px', marginTop: '2px' } }, data.type)))),
        react_1.default.createElement(reactflow_1.Handle, { type: "source", position: reactflow_1.Position.Bottom, style: { background: '#4a9eff', width: 8, height: 8 } })));
}, (prevProps, nextProps) => {
...
exports.PlaceholderNode = (0, react_1.memo)(() => {
    return (react_1.default.createElement("div", { style: {
        ...
        react_1.default.createElement("div", { style: { color: '#666', fontSize: '11px' } }, "Loading...")));
});

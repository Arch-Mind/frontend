...
const ModuleBoundaryDiagram = ({ heatmapMode, highlightNodeIds = [] }) => {
    ...
    return (react_1.default.createElement("div", { className: "boundary-view" },
        ...
        !isLoading && !error && totalBoundaries === 0 && (react_1.default.createElement("div", { className: "boundary-state" }, "No boundaries available yet.")),
        !isLoading && !error && totalBoundaries > 0 && (react_1.default.createElement("div", { className: "boundary-summary" },

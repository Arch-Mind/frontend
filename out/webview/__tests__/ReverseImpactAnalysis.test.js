...
describe('ReverseImpactAnalysisPanel', () => {
    ...
    it('renders and calls backend with correct parameters', async () => {
        ...
        await (0, react_2.waitFor)(() => {
            expect(react_2.screen.getByText(/Reverse Impact Analysis/i)).toBeInTheDocument();
        });
        // Verify fetch was called with correct URL (should include /v1 as fixed earlier)

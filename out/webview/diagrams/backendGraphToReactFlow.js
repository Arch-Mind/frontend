...
exports.simpleLayerLayout = simpleLayerLayout;
 ...
 */
function simpleLayerLayout(nodeIds, edges, opts = {}) {
...
function toReactFlow(graph, { nodeFilter, edgeFilter, direction = "LR", nodeWidth = 240, nodeHeight = 54, } = {}) {
    ...
    const layout = simpleLayerLayout(nodes0.map((n) => n.id), edges0.map((e) => ({ source: e.source, target: e.target })), { direction, nodeWidth, nodeHeight });

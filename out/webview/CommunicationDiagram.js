...
const CommunicationDiagram = ({ heatmapMode, highlightNodeIds = [] }) => {
    ...
    return (react_1.default.createElement("div", { className: "diagram-container" },
        initialLoading && (react_1.default.createElement("div", { className: "loading-container" },
            react_1.default.createElement("div", { className: "loading-spinner" }),
            "Initializing communication diagram...")),
        !initialLoading && !repoId && !data && (react_1.default.createElement("div", { style: { display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100%', textAlign: 'center' } },
            ...
            react_1.default.createElement("p", { style: { opacity: 0.8, maxWidth: '400px', marginBottom: '24px' } }, "Run backend analysis to visualize service communication patterns."),
        ...
        !initialLoading && (repoId || data) && (react_1.default.createElement(react_1.default.Fragment, null,
            ...
            heatmapMode !== 'off' && (react_1.default.createElement(HeatmapLegend_1.HeatmapLegend, { mode: heatmapMode, minMetric: heatmapState.minMetric, maxMetric: heatmapState.maxMetric })),
            ...
            !isLoading && !error && nodes.length === 0 && (react_1.default.createElement("div", { className: "diagram-state" },
                react_1.default.createElement("div", { style: { fontSize: '48px', marginBottom: '16px' } }, "\uD83D\uDCE1"),
                react_1.default.createElement("h3", null, "No Communication Patterns Detected"),
                react_1.default.createElement("p", { style: { opacity: 0.8, maxWidth: '400px', margin: '0 auto 24px' } }, "Analysis found no HTTP, RPC, or Queue interactions."),
            ...
            !isLoading && !error && nodes.length > 0 && (react_1.default.createElement(reactflow_1.ReactFlowProvider, null,

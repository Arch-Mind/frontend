...
const App: React.FC = () => {
  ...
  useEffect(() => {
    const handler = (event: MessageEvent) => {
      ...
      if (
        (message?.command === "switchView" || message?.type === "showView") &&
        incomingView
      ) {
      ...
      if (
        message?.command === "toggleHeatmap" ||
        message?.type === "toggleHeatmap"
      ) {
        setHeatmapMode((prev) => {
          const order: HeatmapMode[] = [
            "off",
            "commit_count",
            "last_modified",
            "author_count",
    ...
    <ThemeProvider>
      ...
      <div className="app-container">
        ...
        <div className="view-toggle">
          ...
          <button
            className={
              activeView === "boundaries" ? "view-tab active" : "view-tab"
            }
          ...
          <button
            className={
              activeView === "boundary-diagram" ? "view-tab active" : "view-tab"
            }
          ...
          <button
            className={
              activeView === "communication" ? "view-tab active" : "view-tab"
            }
          ...
          <button
            className={
              activeView === "webhooks" ? "view-tab active" : "view-tab"
            }
        ...
        <main className="app-main">
          ...
          {activeView === "boundaries" &&
            (console.log("App.tsx: Rendering ModuleBoundaryDiagram", {
              architectureData,
            }),
              (
          ...
          {activeView === "boundary-diagram" &&
            (console.log("App.tsx: Rendering BoundaryDiagram", {
              architectureData,
            }),
              (
                <BoundaryDiagram
